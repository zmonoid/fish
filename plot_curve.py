...
res = [
    re.compile('.*Epoch\[(\d+)\] .*Train-accuracy.*=([.\d]+)'),
...
def main():
    ...
    log_files = glob.glob(os.path.join(args.logs, '*.log'))
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description='Parses log file and generates train/val curves, using like: \n'
